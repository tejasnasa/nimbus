...
export default function CreateWorkspaceCard() {
  return (
    <div className="w-[48.5%] p-6 bg-(--card) rounded-lg flex flex-col justify-between text-center py-10">
      ...
      <AlertDialog trigger={<Button>Create Workspace Wrapper</Button>}>
        {({ close }) => (
          <div className=" relative z-50 w-full max-w-120 rounded-xl border border-(--border) bg-(--card) p-3 shadow-lg animate-in fade-in zoom-in-95 ">
